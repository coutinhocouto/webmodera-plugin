...
function global_cadastra_form()
{
    if (!empty($_POST)) {
        ...
        if (global_crm_exists_validation($crm, $crm_uf)) {
            echo '<label class="error" for="email">Você já está cadastrado. Se não souber sua senha, clique em "Esqueci minha senha" no menu acima</label>';
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" id="cadastramento">
            ...
            <?php if (get_option('mostra_sabendo_global') == "1") { ?>
                <div class="wb-100 md2 nmd">
                    <label form="sabendo">Como ficou sabendo? <?php if (get_option('sabendo_obr_global') == "1") {
                                                                    echo '*';
                                                                } ?></label>
                    <select name="sabendo" <?php if (get_option('sabendo_obr_global') == "1") {
                                                echo 'required';
                                            } ?>>
                        <option></option>
            ...
            <?php if (get_option('mostra_extra') == "1") { ?>
                <div class="wb-100 md2 nmd staff2">
                    <input type="checkbox" name="extra1" value="1" <?php if (get_option('obrigatorio_extra') == "1") {
                                                                        echo 'required';
                                                                    } ?>>
                    <label form="extra1"><?php echo get_option('texto_extra'); ?> <?php if (get_option('obrigatorio_extra') == "1") {
                                                                                        echo '*';
                                                                                    } ?></label>
                </div>
            <?php } ?>
            ...
            <?php if (get_option('mostra_extra2') == "1") { ?>
                <div class="wb-100 md2 nmd staff2">
                    <input type="checkbox" name="extra2" value="1" <?php if (get_option('obrigatorio_extra2') == "1") {
                                                                        echo 'required';
                                                                    } ?>>
                    <label form="extra2"><?php echo get_option('texto_extra2'); ?> <?php if (get_option('obrigatorio_extra2') == "1") {
                                                                                        echo '*';
                                                                                    } ?></label>
                </div>
            <?php } ?>
